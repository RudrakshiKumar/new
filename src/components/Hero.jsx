...
const Hero = () => {
  return (
    <section className='bg-gradient-to-r from-sky-500 to-indigo-500 rounded-br-extraLarge rounded-bl-extraLarge h-96'>
    <div className= "">
    <h1 className="animate-bounce text-pink-600  text-6xl text-center font-black pt-20 drop-shadow-xl">
        About Us
